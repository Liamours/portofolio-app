...
export const useAiLabJourney = () => useFetch<Journey>('/data/journey-ailab.json')
export const useWbbsJourney = () => useFetch<Journey>('/data/journey-wbbs.json')
export const useBirdsoundJourney = () => useFetch<Journey>('/data/journey-birdsound.json')
export const useCxrJourney = () => useFetch<Journey>('/data/journey-cxr.json')
export const useTranstrackJourney = () => useFetch<Journey>('/data/journey-transtrack.json')
